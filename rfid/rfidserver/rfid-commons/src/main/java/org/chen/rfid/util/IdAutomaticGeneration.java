...
/**
 * @author 程强
 * @date 2020年03月22日 21:39
 * @Description:
 */
public class IdAutomaticGeneration {
    /**
    ...
    // 10位进程ID标识
    public IdAutomaticGeneration(long processId) {
    ...
    public static void main(String[] args) throws ParseException {
        IdAutomaticGeneration ig = new IdAutomaticGeneration(1023);
        String str = "20170101";
